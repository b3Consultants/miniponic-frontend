  ...
  render() {
    ...
    return (
      <LineChart width={width} height={height} data={data}
        ...
        <YAxis unit='°C' fontFamily="Roboto, sans-serif" fontSize="12px" />
        ...
        <Line connectNulls dataKey="t1" dot={false} stroke="#8884d8" strokeOpacity={opacity.t1} />
        <Line connectNulls dataKey="t2" dot={false} stroke="#82ca9d" strokeOpacity={opacity.t2} />
      </LineChart>
    )
  }
}
