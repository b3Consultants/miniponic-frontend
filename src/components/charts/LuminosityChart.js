...
class LuminosityChart extends Component {
  constructor(props) {
    super(props);
    this.state = {
      opacity: {
  ...
  render() {
    ...
    return (
      <LineChart width={width} height={height} data={data}
        ...
        <YAxis unit=' lux' fontFamily="Roboto, sans-serif" fontSize="12px" />
        ...
        <Line connectNulls dataKey="lout" dot={false} stroke="#8884d8" strokeOpacity={opacity.lout} />
      </LineChart>
    )
  }
}
